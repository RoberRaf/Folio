import { BookOpen, Menu, Moon, Plus, Sun } from 'lucide-react'
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button
            ...
            className="p-2 rounded-md text-stone-500 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors"
      ...
      <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
        <SheetContent side="left" className="w-72 bg-white dark:bg-stone-950 border-stone-200 dark:border-stone-800">
          ...
          <div className="mt-auto pt-4 border-t border-stone-200 dark:border-stone-800 flex flex-col gap-2">
            <button
              onClick={onToggleDark}
              className="flex items-center gap-2 w-full px-3 py-2.5 text-sm font-medium rounded-lg text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-stone-100 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors"
            >
              {isDark ? <Sun className="w-4 h-4" strokeWidth={1.75} /> : <Moon className="w-4 h-4" strokeWidth={1.75} />}
