import type { FeatureItem } from '@/../product/sections/landing/types'

// Internal per-step config (indexed 0–2)
  ...
  return (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M4 5a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM14 4a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1V4zM14 10a1 1 0 011-1h4a1 1 0 011 1v9a1 1 0 01-1 1h-4a1 1 0 01-1-1v-9z"
      />
    </svg>
  )
}
    ...
    <section className="bg-stone-50 dark:bg-stone-950 py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="mb-16 sm:mb-20 text-center">
          ...
          <h2
            className="text-4xl sm:text-5xl font-bold text-stone-900 dark:text-white"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={feature.id}
                className="group flex flex-col bg-white dark:bg-stone-900 rounded-3xl border border-stone-100 dark:border-stone-800 overflow-hidden hover:border-rose-200/70 dark:hover:border-stone-700 transition-colors duration-300 hover:shadow-lg hover:shadow-rose-500/5"
              >
                ...
                {feature.imagePlaceholder && (
                  <div className={`relative h-52 bg-gradient-to-br ${gradient} overflow-hidden`}>
                    ...
                    <span
                      className="absolute -bottom-4 -right-1 text-[96px] font-bold text-white/5 leading-none select-none pointer-events-none"
                      style={{ fontFamily: "'Playfair Display', serif" }}
                    >
                      {stepNum}
                    </span>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className={`w-14 h-14 rounded-2xl border flex items-center justify-center ${iconRing}`}>
                        {icon}
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex-1 p-6 sm:p-7">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-xs font-medium text-rose-400 tracking-[0.15em] font-mono">
                      {stepNum}
                    </span>
                  ...
                  <h3
                    className="text-xl font-bold text-stone-900 dark:text-white mb-3"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                    {feature.title}
                  </h3>
