import type { BookDesignerProps } from '@/../product/sections/book-designer/types'
    ...
    <div className="h-screen flex flex-col bg-stone-100 dark:bg-stone-950 overflow-hidden">
      ...
      <header className="flex-shrink-0 flex items-center gap-3 px-4 sm:px-5 py-3 bg-white dark:bg-stone-950 border-b border-stone-200 dark:border-stone-800">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <span
            className="text-sm text-stone-400 dark:text-stone-500 hidden sm:block"
        ...
        <div className="flex-1 min-w-0">
          <h1
            className="text-base font-semibold text-stone-900 dark:text-white truncate"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            {book.title}
          </h1>
        ...
        <button
          ...
          className="flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-full bg-rose-500 hover:bg-rose-400 active:bg-rose-600 active:scale-[0.97] text-white text-sm font-semibold transition-all duration-150 hover:shadow-[0_4px_20px_rgba(244,63,94,0.4)] hover:-translate-y-px"
        >
